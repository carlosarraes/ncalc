...
func SodiumFromSalt(mg float64) SodiumMilligram {
	return SodiumMilligram(mg / 2.5)
}
...
func GetNutritionalScore(n NutritionalData, st ScoreType) NutritionalScore {
	...
	if st != Water {
		...
		positive = fruitPoints + fibrePoints + n.Proteins.GetPoints(st)
